# nomad-plugin-aflow-vasp-parser

Combine the aflow.in with vasp.xml
...
```sh
git clone https://github.com/foo/nomad-plugin-aflow-vasp-parser.git
cd nomad-plugin-aflow-vasp-parser
